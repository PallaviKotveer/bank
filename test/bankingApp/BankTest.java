...
public class BankTest {
	...
	@Test
	public void testOpenAccount() throws AccountDoesNotExistException  {
	...
	public void testTransfer() throws AccountDoesNotExistException {
		...
		assertThrows(AccountDoesNotExistException.class, ()->this.TD.transfer("Garvit", HSBC, "xyz", new Money(200.1551, CAD)));
		assertThrows(AccountDoesNotExistException.class, ()->this.HSBC.transfer("Pallavi", RBC, "abc", new Money(23.121, CAD)));
		assertThrows(AccountDoesNotExistException.class, ()->this.HSBC.transfer("Pallavi", "pqr", new Money(34.541, CAD)));
